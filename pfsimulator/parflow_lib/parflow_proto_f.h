...
#define CALL_CLM_LSM(pressure_data, saturation_data, evap_trans_data, mask, porosity_data,                                                                                     \
                     ...
                     clm_dump_interval, clm_1d_out, clm_forc_veg, clm_prec_roots, clm_critic_temp, clm_snow_frac, clm_file_dir, clm_file_dir_length, clm_bin_out_dir, write_CLM_binary, slope_accounting_CLM,                  \
  ...
  CLM_LSM(pressure_data, saturation_data, evap_trans_data, mask, porosity_data,                                                                                                \
          ...
          &clm_dump_interval, &clm_1d_out, &clm_forc_veg, &clm_prec_roots, &clm_critic_temp, &clm_snow_frac, clm_file_dir, &clm_file_dir_length, &clm_bin_out_dir,             \
...
void CLM_LSM(double *pressure_data, double *saturation_data, double *evap_trans_data, double *mask, double *porosity_data,
             ...
             int *clm_forc_veg, int *clm_prec_roots, double *clm_critic_temp, int *clm_snow_frac, char *clm_file_dir, int *clm_file_dir_length, int *clm_bin_out_dir, int *write_CLM_binary, int *slope_accounting_CLM, int *clm_beta_function,
